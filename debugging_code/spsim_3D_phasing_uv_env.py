...
emc_file = "emc/protein_water_no_ds_0001/data_100k_4x_unmasked_resampled/prot_only_0/output_220.h5"
...
blur_i, blur_f = 2.0, 1.0
supp_update = 20

niter_store_errors = 3
...
for i in range(n_recons):
    ...
    phaser.append_support_algorithm(
        ...
        number_of_iterations=niter_alg + niter_er - 1
    )
